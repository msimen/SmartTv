 ...
 */
public class TVFreeModeBroadcastReceiver extends ItriBroadcastReceiverBase {
    private ITVFreeModeBroadcastReceiverDelegateListener mDelegateListener;

    public TVFreeModeBroadcastReceiver(Activity host) {
        super(host);
    }

    public void setDelegateListener(
            ITVFreeModeBroadcastReceiverDelegateListener delegateListener) {
    ...
    protected void onInitializeIntentFilter() {
        ...
        this.intentFilter.addAction(TVModeBroadcastReceiver.ACTION_BROADCAST_FREEMODERECEIVE);
    }

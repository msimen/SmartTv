 ...
 */
public class TVHideModeBroadcastReceiver extends ItriBroadcastReceiverBase {
    private ITVHideModeBroadcastReceiverDelegateListener mDelegateListener;

    public TVHideModeBroadcastReceiver(Activity host) {
        super(host);
    }

    public void setDelegateListener(
            ITVHideModeBroadcastReceiverDelegateListener delegateListener) {
    ...
    protected void onInitializeIntentFilter() {
        ...
        this.intentFilter.addAction(TVModeBroadcastReceiver.ACTION_BROADCAST_HIDEMODERECEIVE);
    }

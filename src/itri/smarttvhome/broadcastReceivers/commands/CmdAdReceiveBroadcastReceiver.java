 ...
 */
public class CmdAdReceiveBroadcastReceiver extends ItriBroadcastReceiverBase {
    private ICmdAdReceiveBroadcastReceiverDelegateListener mDelegateListener;

    public CmdAdReceiveBroadcastReceiver(Activity host) {
        super(host);
    }
    ...
    protected void onInitializeIntentFilter() {
        ...
        this.intentFilter.addAction(CmdReceiveBroadcastReceiver.ACTION_BROADCAST_ADCMDRECEIVE);
    }

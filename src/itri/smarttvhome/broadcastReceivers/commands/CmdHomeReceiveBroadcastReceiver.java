 ...
 */
public class CmdHomeReceiveBroadcastReceiver extends ItriBroadcastReceiverBase {
    private ICmdHomeReceiveBroadcastReceiverDelegateListener mDelegateListener;

    public CmdHomeReceiveBroadcastReceiver(Activity host) {
        super(host);
    }

    public void setDelegateListener(
            ICmdHomeReceiveBroadcastReceiverDelegateListener delegateListener) {
    ...
    protected void onInitializeIntentFilter() {
        ...
        this.intentFilter.addAction(CmdReceiveBroadcastReceiver.ACTION_BROADCAST_HOMECMDRECEIVE);
    }

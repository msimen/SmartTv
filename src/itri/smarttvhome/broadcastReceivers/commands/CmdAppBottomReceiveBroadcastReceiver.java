 ...
 */
public class CmdAppBottomReceiveBroadcastReceiver extends ItriBroadcastReceiverBase {
    private ICmdAdReceiveBroadcastReceiverDelegateListener mDelegateListener;

    public CmdAppBottomReceiveBroadcastReceiver(Activity host) {
        super(host);
    }

    public void setDelegateListener(
            ICmdAdReceiveBroadcastReceiverDelegateListener delegateListener) {
    ...
    protected void onInitializeIntentFilter() {
        ...
        this.intentFilter.addAction(CmdReceiveBroadcastReceiver.ACTION_BROADCAST_ABCMDRECEIVE);
    }

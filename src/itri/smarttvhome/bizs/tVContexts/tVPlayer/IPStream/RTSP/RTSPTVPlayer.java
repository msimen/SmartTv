 ...
 */
public class RTSPTVPlayer extends TVPlayerBase {
    ...
    public RTSPTVPlayer(Activity host, RelativeLayout layout) {
        super(host, layout);
        this.channelHLSMapor = new MOSChannelRTSPMapor();
...
//        this.onStandardTVShow();
        ...
        this.standardTV.setOnCompletionListener(new MediaPlayer.OnCompletionListener(){
            @Override
...
//                tvPlay(false);
        ...
        this.standardTV.setOnErrorListener(new MediaPlayer.OnErrorListener(){
            @Override
            public boolean onError(MediaPlayer mp, int what, int extra) {
//                standardTV.pause();
                mp.stop();
...
//        if(backResult.getChannelCode().equals("99")||backResult.getChannelCode().equals("100"))
//        {
//            this.channelAddress = backResult.getChannelUrAddress();
//        }
//        else {
...
//        }
    ...
    protected String toPreChannelHandle() {
        ...
        Toast.makeText(this.host, "channel:" + backResult.getChannelCode(),

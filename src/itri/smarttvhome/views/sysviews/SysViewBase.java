 ...
 */
public abstract class SysViewBase extends RelativeLayout {
    private ISysFloatViewDelegateListener mDelegateListener;

    public SysViewBase(Context context) {
        super(context);
    }

    public SysViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SysViewBase(Context context, AttributeSet attrs, int defStyleAttr) {

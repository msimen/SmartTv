 ...
 */
public class IstDownBroadcastReceiver extends ItriBroadcastReceiverBase {
    private IIstDownBroadcastReceiverDelegateListener mDelegateListener;

    public IstDownBroadcastReceiver(Activity host) {
        super(host);
    }

    public void setDelegateListener(
            IIstDownBroadcastReceiverDelegateListener
                    delegateListener) {
    ...
    protected void onInitializeIntentFilter() {
        ...
        this.intentFilter.addAction(InstructionBroadcastReceiver.ACTION_BROADCAST_DOWNISTRECEIVE);
    }

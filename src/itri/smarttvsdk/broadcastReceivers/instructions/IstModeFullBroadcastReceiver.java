 ...
 */
public class IstModeFullBroadcastReceiver extends ItriBroadcastReceiverBase {
    private IIstModeFullBroadcastReceiverDelegateListener mDelegateListener;

    public IstModeFullBroadcastReceiver(Activity host) {
        super(host);
    }

    public void setDelegateListener(
            IIstModeFullBroadcastReceiverDelegateListener delegateListener) {
    ...
    protected void onInitializeIntentFilter() {
        ...
        this.intentFilter.addAction(InstructionBroadcastReceiver.ACTION_BROADCAST_MFISTRECEIVE);
    }

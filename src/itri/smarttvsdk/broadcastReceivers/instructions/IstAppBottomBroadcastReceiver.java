 ...
 */
public class IstAppBottomBroadcastReceiver extends ItriBroadcastReceiverBase {
    private IIstAppBottomBroadcastReceiverDelegateListener mDelegateListener;

    public IstAppBottomBroadcastReceiver(Activity host) {
        super(host);
    }

    public void setDelegateListener(
            IIstAppBottomBroadcastReceiverDelegateListener
                    delegateListener) {
    ...
    protected void onInitializeIntentFilter() {
        ...
        this.intentFilter.addAction(InstructionBroadcastReceiver.ACTION_BROADCAST_ABISTRECEIVE);
    }

 ...
 */
public class IstLeftBroadcastSender extends BroadcastSenderBase {
    public IstLeftBroadcastSender(Context ctx) {
        super(ctx);
        this.getSendItent().setAction(InstructionBroadcastReceiver.ACTION_BROADCAST_LEFTISTRECEIVE);
    }
}

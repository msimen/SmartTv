 ...
 */
public class IstBackBroadcastSender extends BroadcastSenderBase {
    public IstBackBroadcastSender(Context ctx) {
        super(ctx);
        this.getSendItent().setAction(InstructionBroadcastReceiver.ACTION_BROADCAST_BACKISTRECEIVE);
    }
}

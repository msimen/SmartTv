 ...
 */
public class IstDownBroadcastSender extends BroadcastSenderBase {
    public IstDownBroadcastSender(Context ctx) {
        super(ctx);
        this.getSendItent().setAction(InstructionBroadcastReceiver.ACTION_BROADCAST_DOWNISTRECEIVE);
    }
}

 ...
 */
public class IstRightBroadcastSender extends BroadcastSenderBase {
    public IstRightBroadcastSender(Context ctx) {
        super(ctx);
        this.getSendItent().setAction(InstructionBroadcastReceiver.ACTION_BROADCAST_RIGHTISTRECEIVE);
    }
}

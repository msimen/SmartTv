 ...
 */
public class IstHomeBroadcastSender extends BroadcastSenderBase {
    public IstHomeBroadcastSender(Context ctx) {
        super(ctx);
        this.getSendItent().setAction(InstructionBroadcastReceiver.ACTION_BROADCAST_HOMEISTRECEIVE);
    }
}

 ...
 */
public class CmdBackBroadcastSender extends BroadcastSenderBase {
    public CmdBackBroadcastSender(Context ctx) {
        super(ctx);
        this.getSendItent().setAction(CmdReceiveBroadcastReceiver.ACTION_BROADCAST_BACKCMDRECEIVE);
    }
}
